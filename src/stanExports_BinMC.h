...
namespace model_BinMC_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_BinMC");
    ...
    reader.add_event(22, 6, "restart", "model_BinMC");
    reader.add_event(33, 17, "include", "/include/tdata_lgtd.stan");
    reader.add_event(33, 0, "start", "/include/tdata_lgtd.stan");
    reader.add_event(67, 34, "end", "/include/tdata_lgtd.stan");
    reader.add_event(67, 18, "restart", "model_BinMC");
    reader.add_event(147, 96, "end", "model_BinMC");
    return reader;
}
#include <stan_meta_header.hpp>
class model_BinMC
  : public stan::model::model_base_crtp<model_BinMC> {
private:
        int N_obs;
        int N_pt;
        ...
        std::vector<double> prior_mu_logit_p10;
        std::vector<double> prior_sigma_logit_p10;
        std::vector<double> prior_logit_tss1_0;
        int run;
...
public:
    model_BinMC(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_BinMC_namespace::model_BinMC";
        ...
        try {
            ...
            validate_non_negative_index("prior_mu_logit_p10", "2", 2);
            context__.validate_dims("data initialization", "prior_mu_logit_p10", "double", context__.to_vec(2));
            prior_mu_logit_p10 = std::vector<double>(2, double(0));
            vals_r__ = context__.vals_r("prior_mu_logit_p10");
            pos__ = 0;
            size_t prior_mu_logit_p10_k_0_max__ = 2;
            for (size_t k_0__ = 0; k_0__ < prior_mu_logit_p10_k_0_max__; ++k_0__) {
                prior_mu_logit_p10[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 26;
            validate_non_negative_index("prior_sigma_logit_p10", "2", 2);
            context__.validate_dims("data initialization", "prior_sigma_logit_p10", "double", context__.to_vec(2));
            prior_sigma_logit_p10 = std::vector<double>(2, double(0));
            vals_r__ = context__.vals_r("prior_sigma_logit_p10");
            pos__ = 0;
            size_t prior_sigma_logit_p10_k_0_max__ = 2;
            for (size_t k_0__ = 0; k_0__ < prior_sigma_logit_p10_k_0_max__; ++k_0__) {
                prior_sigma_logit_p10[k_0__] = vals_r__[pos__++];
            }
            current_statement_begin__ = 27;
            validate_non_negative_index("prior_logit_tss1_0", "2", 2);
            context__.validate_dims("data initialization", "prior_logit_tss1_0", "double", context__.to_vec(2));
            prior_logit_tss1_0 = std::vector<double>(2, double(0));
            vals_r__ = context__.vals_r("prior_logit_tss1_0");
            pos__ = 0;
            size_t prior_logit_tss1_0_k_0_max__ = 2;
            for (size_t k_0__ = 0; k_0__ < prior_logit_tss1_0_k_0_max__; ++k_0__) {
                prior_logit_tss1_0[k_0__] = vals_r__[pos__++];
            }
            ...
            validate_non_negative_index("eta_logit_p10", "N_pt", N_pt);
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 74;
        if (!(context__.contains_r("eta_logit_p10")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable eta_logit_p10 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("eta_logit_p10");
        pos__ = 0U;
        validate_non_negative_index("eta_logit_p10", "N_pt", N_pt);
        context__.validate_dims("parameter initialization", "eta_logit_p10", "double", context__.to_vec(N_pt));
        std::vector<double> eta_logit_p10(N_pt, double(0));
        size_t eta_logit_p10_k_0_max__ = N_pt;
        for (size_t k_0__ = 0; k_0__ < eta_logit_p10_k_0_max__; ++k_0__) {
            eta_logit_p10[k_0__] = vals_r__[pos__++];
        }
        size_t eta_logit_p10_i_0_max__ = N_pt;
        for (size_t i_0__ = 0; i_0__ < eta_logit_p10_i_0_max__; ++i_0__) {
            try {
                writer__.scalar_unconstrain(eta_logit_p10[i_0__]);
            } catch (const std::exception& e) {
                stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable eta_logit_p10: ") + e.what()), current_statement_begin__, prog_reader__());
            }
        }
        current_statement_begin__ = 75;
        if (!(context__.contains_r("mu_logit_p10")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable mu_logit_p10 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("mu_logit_p10");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "mu_logit_p10", "double", context__.to_vec());
        double mu_logit_p10(0);
        mu_logit_p10 = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(mu_logit_p10);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable mu_logit_p10: ") + e.what()), current_statement_begin__, prog_reader__());
        }
        current_statement_begin__ = 76;
        if (!(context__.contains_r("sigma_logit_p10")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable sigma_logit_p10 missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("sigma_logit_p10");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sigma_logit_p10", "double", context__.to_vec());
        double sigma_logit_p10(0);
        sigma_logit_p10 = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(0, sigma_logit_p10);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable sigma_logit_p10: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 74;
            std::vector<local_scalar_t__> eta_logit_p10;
            size_t eta_logit_p10_d_0_max__ = N_pt;
            eta_logit_p10.reserve(eta_logit_p10_d_0_max__);
            for (size_t d_0__ = 0; d_0__ < eta_logit_p10_d_0_max__; ++d_0__) {
                if (jacobian__)
                    eta_logit_p10.push_back(in__.scalar_constrain(lp__));
                else
                    eta_logit_p10.push_back(in__.scalar_constrain());
            }
            current_statement_begin__ = 75;
            local_scalar_t__ mu_logit_p10;
            (void) mu_logit_p10;  // dummy to suppress unused var warning
            if (jacobian__)
                mu_logit_p10 = in__.scalar_constrain(lp__);
            else
                mu_logit_p10 = in__.scalar_constrain();
            current_statement_begin__ = 76;
            local_scalar_t__ sigma_logit_p10;
            (void) sigma_logit_p10;  // dummy to suppress unused var warning
            if (jacobian__)
                sigma_logit_p10 = in__.scalar_lb_constrain(0, lp__);
            else
                sigma_logit_p10 = in__.scalar_lb_constrain(0);
            // transformed parameters
            current_statement_begin__ = 80;
            validate_non_negative_index("logit_p10", "N_pt", N_pt);
            std::vector<local_scalar_t__> logit_p10(N_pt, local_scalar_t__(0));
            stan::math::initialize(logit_p10, DUMMY_VAR__);
            stan::math::fill(logit_p10, DUMMY_VAR__);
            current_statement_begin__ = 81;
            validate_non_negative_index("p10", "N_pt", N_pt);
            std::vector<local_scalar_t__> p10(N_pt, local_scalar_t__(0));
            stan::math::initialize(p10, DUMMY_VAR__);
            stan::math::fill(p10, DUMMY_VAR__);
            current_statement_begin__ = 82;
            validate_non_negative_index("p11", "N_pt", N_pt);
            std::vector<local_scalar_t__> p11(N_pt, local_scalar_t__(0));
            stan::math::initialize(p11, DUMMY_VAR__);
            stan::math::fill(p11, DUMMY_VAR__);
            current_statement_begin__ = 83;
            validate_non_negative_index("logit_tss1_0", "N_pt", N_pt);
            std::vector<local_scalar_t__> logit_tss1_0(N_pt, local_scalar_t__(0));
            stan::math::initialize(logit_tss1_0, DUMMY_VAR__);
            stan::math::fill(logit_tss1_0, DUMMY_VAR__);
            current_statement_begin__ = 84;
            validate_non_negative_index("logit_tss1", "N", N);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> logit_tss1(N);
            stan::math::initialize(logit_tss1, DUMMY_VAR__);
            stan::math::fill(logit_tss1, DUMMY_VAR__);
            current_statement_begin__ = 85;
            validate_non_negative_index("ss1", "N", N);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> ss1(N);
            stan::math::initialize(ss1, DUMMY_VAR__);
            stan::math::fill(ss1, DUMMY_VAR__);
            current_statement_begin__ = 86;
            validate_non_negative_index("p01", "N", N);
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, 1> p01(N);
            ...
            for (int k = 1; k <= N_pt; ++k) {
                ...
                stan::model::assign(logit_p10, 
                            stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                            (mu_logit_p10 + (sigma_logit_p10 * get_base1(eta_logit_p10, k, "eta_logit_p10", 1))), 
                            "assigning variable logit_p10");
                current_statement_begin__ = 93;
                stan::model::assign(p10, 
                            stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                            inv_logit(get_base1(logit_p10, k, "logit_p10", 1)), 
                            "assigning variable p10");
                current_statement_begin__ = 94;
                stan::model::assign(p11, 
                            stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                            (1 - get_base1(p10, k, "p10", 1)), 
                            "assigning variable p11");
                current_statement_begin__ = 95;
                stan::model::assign(logit_tss1_0, 
                            stan::model::cons_list(stan::model::index_uni(k), stan::model::nil_index_list()), 
                            (get_base1(prior_logit_tss1_0, 1, "prior_logit_tss1_0", 1) + (get_base1(prior_logit_tss1_0, 2, "prior_logit_tss1_0", 1) * get_base1(eta, get_base1(id_start, k, "id_start", 1), "eta", 1))), 
                            "assigning variable logit_tss1_0");
                current_statement_begin__ = 96;
                for (int t = get_base1(id_start, k, "id_start", 1); t <= get_base1(id_end, k, "id_end", 1); ++t) {
                    current_statement_begin__ = 97;
                    if (as_bool(logical_eq(t, get_base1(id_start, k, "id_start", 1)))) {
                        current_statement_begin__ = 98;
                        stan::model::assign(logit_tss1, 
                                    stan::model::cons_list(stan::model::index_uni(get_base1(id_start, k, "id_start", 1)), stan::model::nil_index_list()), 
                                    get_base1(logit_tss1_0, k, "logit_tss1_0", 1), 
                                    "assigning variable logit_tss1");
                    } else {
                        current_statement_begin__ = 100;
                        stan::model::assign(logit_tss1, 
                                    stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                    (get_base1(logit_tss1, (t - 1), "logit_tss1", 1) + (sigma * get_base1(eta, t, "eta", 1))), 
                                    "assigning variable logit_tss1");
                    }
                    current_statement_begin__ = 102;
                    stan::model::assign(ss1, 
                                stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                (inv_logit(get_base1(logit_tss1, t, "logit_tss1", 1)) / (1 + get_base1(p10, k, "p10", 1))), 
                                "assigning variable ss1");
                    current_statement_begin__ = 103;
                    stan::model::assign(p01, 
                                stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                ((get_base1(p10, k, "p10", 1) * get_base1(ss1, t, "ss1", 1)) / (1 - get_base1(ss1, t, "ss1", 1))), 
                                "assigning variable p01");
                    current_statement_begin__ = 104;
                    stan::model::assign(lambda, 
                                stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                ((1 - get_base1(p10, k, "p10", 1)) - get_base1(p01, t, "p01", 1)), 
                    ...
                    if (as_bool(logical_eq(t, get_base1(id_start, k, "id_start", 1)))) {
                        ...
                        stan::model::assign(y_lat, 
                                    stan::model::cons_list(stan::model::index_uni(get_base1(id_start, k, "id_start", 1)), stan::model::nil_index_list()), 
                                    get_base1(ss1, get_base1(id_start, k, "id_start", 1), "ss1", 1), 
                                    "assigning variable y_lat");
                    } else {
                        current_statement_begin__ = 108;
                        stan::model::assign(y_lat, 
                                    stan::model::cons_list(stan::model::index_uni(t), stan::model::nil_index_list()), 
                                    ((get_base1(p01, t, "p01", 1) * (1 - get_base1(y_lat, (t - 1), "y_lat", 1))) + (get_base1(p11, k, "p11", 1) * get_base1(y_lat, (t - 1), "y_lat", 1))), 
                                    "assigning variable y_lat");
                    }
                }
            }
            ...
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 80;
            size_t logit_p10_k_0_max__ = N_pt;
            for (size_t k_0__ = 0; k_0__ < logit_p10_k_0_max__; ++k_0__) {
                if (stan::math::is_uninitialized(logit_p10[k_0__])) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: logit_p10" << "[" << k_0__ << "]";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable logit_p10: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 81;
            size_t p10_k_0_max__ = N_pt;
            for (size_t k_0__ = 0; k_0__ < p10_k_0_max__; ++k_0__) {
                if (stan::math::is_uninitialized(p10[k_0__])) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: p10" << "[" << k_0__ << "]";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable p10: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 82;
            size_t p11_k_0_max__ = N_pt;
            ...
            current_statement_begin__ = 83;
            size_t logit_tss1_0_k_0_max__ = N_pt;
            for (size_t k_0__ = 0; k_0__ < logit_tss1_0_k_0_max__; ++k_0__) {
                if (stan::math::is_uninitialized(logit_tss1_0[k_0__])) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: logit_tss1_0" << "[" << k_0__ << "]";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable logit_tss1_0: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 84;
            size_t logit_tss1_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < logit_tss1_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(logit_tss1(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: logit_tss1" << "(" << j_1__ << ")";
                    stan::lang::rethrow_located(std::runtime_error(std::string("Error initializing variable logit_tss1: ") + msg__.str()), current_statement_begin__, prog_reader__());
                }
            }
            current_statement_begin__ = 85;
            size_t ss1_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < ss1_j_1_max__; ++j_1__) {
                if (stan::math::is_uninitialized(ss1(j_1__))) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: ss1" << "(" << j_1__ << ")";
            ...
            lp_accum__.add(std_normal_log<propto__>(eta_logit_p10));
            ...
            lp_accum__.add(normal_log<propto__>(mu_logit_p10, get_base1(prior_mu_logit_p10, 1, "prior_mu_logit_p10", 1), get_base1(prior_mu_logit_p10, 2, "prior_mu_logit_p10", 1)));
            current_statement_begin__ = 120;
            lp_accum__.add(normal_log<propto__>(sigma_logit_p10, get_base1(prior_sigma_logit_p10, 1, "prior_sigma_logit_p10", 1), get_base1(prior_sigma_logit_p10, 2, "prior_sigma_logit_p10", 1)));
    ...
    void get_param_names(std::vector<std::string>& names__) const {
        ...
        names__.push_back("eta_logit_p10");
        names__.push_back("mu_logit_p10");
        names__.push_back("sigma_logit_p10");
        names__.push_back("logit_p10");
        names__.push_back("p10");
        names__.push_back("p11");
        names__.push_back("logit_tss1_0");
        names__.push_back("logit_tss1");
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_BinMC_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        std::vector<double> eta_logit_p10;
        size_t eta_logit_p10_d_0_max__ = N_pt;
        eta_logit_p10.reserve(eta_logit_p10_d_0_max__);
        for (size_t d_0__ = 0; d_0__ < eta_logit_p10_d_0_max__; ++d_0__) {
            eta_logit_p10.push_back(in__.scalar_constrain());
        ...
        size_t eta_logit_p10_k_0_max__ = N_pt;
        for (size_t k_0__ = 0; k_0__ < eta_logit_p10_k_0_max__; ++k_0__) {
            vars__.push_back(eta_logit_p10[k_0__]);
        }
        double mu_logit_p10 = in__.scalar_constrain();
        vars__.push_back(mu_logit_p10);
        double sigma_logit_p10 = in__.scalar_lb_constrain(0);
        vars__.push_back(sigma_logit_p10);
        double lp__ = 0.0;
        ...
        try {
            ...
            current_statement_begin__ = 80;
            validate_non_negative_index("logit_p10", "N_pt", N_pt);
            std::vector<double> logit_p10(N_pt, double(0));
            stan::math::initialize(logit_p10, DUMMY_VAR__);
            stan::math::fill(logit_p10, DUMMY_VAR__);
            current_statement_begin__ = 81;
            validate_non_negative_index("p10", "N_pt", N_pt);
            std::vector<double> p10(N_pt, double(0));
            stan::math::initialize(p10, DUMMY_VAR__);
            stan::math::fill(p10, DUMMY_VAR__);
            current_statement_begin__ = 82;
            validate_non_negative_index("p11", "N_pt", N_pt);
            std::vector<double> p11(N_pt, double(0));
            stan::math::initialize(p11, DUMMY_VAR__);
            stan::math::fill(p11, DUMMY_VAR__);
            current_statement_begin__ = 83;
            validate_non_negative_index("logit_tss1_0", "N_pt", N_pt);
            std::vector<double> logit_tss1_0(N_pt, double(0));
            stan::math::initialize(logit_tss1_0, DUMMY_VAR__);
            stan::math::fill(logit_tss1_0, DUMMY_VAR__);
            current_statement_begin__ = 84;
            validate_non_negative_index("logit_tss1", "N", N);
            Eigen::Matrix<double, Eigen::Dynamic, 1> logit_tss1(N);
            stan::math::initialize(logit_tss1, DUMMY_VAR__);
            stan::math::fill(logit_tss1, DUMMY_VAR__);
            current_statement_begin__ = 85;
            validate_non_negative_index("ss1", "N", N);
            Eigen::Matrix<double, Eigen::Dynamic, 1> ss1(N);
            stan::math::initialize(ss1, DUMMY_VAR__);
            stan::math::fill(ss1, DUMMY_VAR__);
            current_statement_begin__ = 86;
            validate_non_negative_index("p01", "N", N);
            Eigen::Matrix<double, Eigen::Dynamic, 1> p01(N);
            stan::math::initialize(p01, DUMMY_VAR__);
            stan::math::fill(p01, DUMMY_VAR__);
            current_statement_begin__ = 87;
            validate_non_negative_index("lambda", "N", N);
            ...
            if (include_tparams__) {
                size_t logit_p10_k_0_max__ = N_pt;
                for (size_t k_0__ = 0; k_0__ < logit_p10_k_0_max__; ++k_0__) {
                    vars__.push_back(logit_p10[k_0__]);
                }
                size_t p10_k_0_max__ = N_pt;
                for (size_t k_0__ = 0; k_0__ < p10_k_0_max__; ++k_0__) {
                    vars__.push_back(p10[k_0__]);
                }
                size_t p11_k_0_max__ = N_pt;
                for (size_t k_0__ = 0; k_0__ < p11_k_0_max__; ++k_0__) {
                ...
                size_t logit_tss1_0_k_0_max__ = N_pt;
                for (size_t k_0__ = 0; k_0__ < logit_tss1_0_k_0_max__; ++k_0__) {
                    vars__.push_back(logit_tss1_0[k_0__]);
                }
                size_t logit_tss1_j_1_max__ = N;
                for (size_t j_1__ = 0; j_1__ < logit_tss1_j_1_max__; ++j_1__) {
                    vars__.push_back(logit_tss1(j_1__));
                }
                size_t ss1_j_1_max__ = N;
                for (size_t j_1__ = 0; j_1__ < ss1_j_1_max__; ++j_1__) {
                    vars__.push_back(ss1(j_1__));
                }
                size_t p01_j_1_max__ = N;
                for (size_t j_1__ = 0; j_1__ < p01_j_1_max__; ++j_1__) {
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        for (size_t k_0__ = 0; k_0__ < eta_logit_p10_k_0_max__; ++k_0__) {
            param_name_stream__.str(std::string());
            param_name_stream__ << "eta_logit_p10" << '.' << k_0__ + 1;
            param_names__.push_back(param_name_stream__.str());
        }
        param_name_stream__.str(std::string());
        param_name_stream__ << "mu_logit_p10";
        param_names__.push_back(param_name_stream__.str());
        param_name_stream__.str(std::string());
        param_name_stream__ << "sigma_logit_p10";
        param_names__.push_back(param_name_stream__.str());
        if (!include_gqs__ && !include_tparams__) return;
        if (include_tparams__) {
            size_t logit_p10_k_0_max__ = N_pt;
            for (size_t k_0__ = 0; k_0__ < logit_p10_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "logit_p10" << '.' << k_0__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t p10_k_0_max__ = N_pt;
            for (size_t k_0__ = 0; k_0__ < p10_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "p10" << '.' << k_0__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t p11_k_0_max__ = N_pt;
            for (size_t k_0__ = 0; k_0__ < p11_k_0_max__; ++k_0__) {
            ...
            for (size_t k_0__ = 0; k_0__ < logit_tss1_0_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "logit_tss1_0" << '.' << k_0__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t logit_tss1_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < logit_tss1_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "logit_tss1" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t ss1_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < ss1_j_1_max__; ++j_1__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "ss1" << '.' << j_1__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t p01_j_1_max__ = N;
            for (size_t j_1__ = 0; j_1__ < p01_j_1_max__; ++j_1__) {
...
typedef model_BinMC_namespace::model_BinMC stan_model;
#ifndef USING_R
