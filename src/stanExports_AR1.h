...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_AR1");
    ...
    reader.add_event(35, 8, "restart", "model_AR1");
    ...
    reader.add_event(55, 12, "restart", "model_AR1");
    reader.add_event(63, 20, "include", "/include/tdata_lgtd.stan");
    reader.add_event(63, 0, "start", "/include/tdata_lgtd.stan");
    reader.add_event(97, 34, "end", "/include/tdata_lgtd.stan");
    reader.add_event(97, 21, "restart", "model_AR1");
    reader.add_event(110, 34, "include", "/include/tparameters_missing.stan");
    reader.add_event(110, 0, "start", "/include/tparameters_missing.stan");
    reader.add_event(124, 14, "end", "/include/tparameters_missing.stan");
    reader.add_event(124, 35, "restart", "model_AR1");
    reader.add_event(163, 72, "end", "model_AR1");
    return reader;
}
...
class model_AR1
  : public stan::model::model_base_crtp<model_AR1> {
private:
        int N_obs;
        int N_pt;
...
public:
    model_AR1(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_AR1_namespace::model_AR1";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "prior_alpha", "double", context__.to_vec(2));
            prior_alpha = std::vector<double>(2, double(0));
            vals_r__ = context__.vals_r("prior_alpha");
            pos__ = 0;
            size_t prior_alpha_k_0_max__ = 2;
            for (size_t k_0__ = 0; k_0__ < prior_alpha_k_0_max__; ++k_0__) {
                prior_alpha[k_0__] = vals_r__[pos__++];
            }
            size_t prior_alpha_i_0_max__ = 2;
            for (size_t i_0__ = 0; i_0__ < prior_alpha_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "prior_alpha[i_0__]", prior_alpha[i_0__], 0);
            }
            current_statement_begin__ = 59;
            validate_non_negative_index("prior_y_inf", "2", 2);
            context__.validate_dims("data initialization", "prior_y_inf", "double", context__.to_vec(2));
            prior_y_inf = std::vector<double>(2, double(0));
            vals_r__ = context__.vals_r("prior_y_inf");
            pos__ = 0;
            size_t prior_y_inf_k_0_max__ = 2;
            for (size_t k_0__ = 0; k_0__ < prior_y_inf_k_0_max__; ++k_0__) {
                prior_y_inf[k_0__] = vals_r__[pos__++];
            }
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        current_statement_begin__ = 106;
        if (!(context__.contains_r("y_inf")))
            stan::lang::rethrow_located(std::runtime_error(std::string("Variable y_inf missing")), current_statement_begin__, prog_reader__());
        vals_r__ = context__.vals_r("y_inf");
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "y_inf", "double", context__.to_vec());
        double y_inf(0);
        y_inf = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(y_inf);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(std::runtime_error(std::string("Error transforming variable y_inf: ") + e.what()), current_statement_begin__, prog_reader__());
        }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 106;
            local_scalar_t__ y_inf;
            (void) y_inf;  // dummy to suppress unused var warning
            if (jacobian__)
                y_inf = in__.scalar_constrain(lp__);
            else
                y_inf = in__.scalar_constrain();
            ...
            stan::math::assign(b,(y_inf * (1 - alpha)));
            ...
            lp_accum__.add(beta_log<propto__>(alpha, get_base1(prior_alpha, 1, "prior_alpha", 1), get_base1(prior_alpha, 2, "prior_alpha", 1)));
            current_statement_begin__ = 130;
            lp_accum__.add(normal_log<propto__>((y_inf / M), get_base1(prior_y_inf, 1, "prior_y_inf", 1), get_base1(prior_y_inf, 2, "prior_y_inf", 1)));
            current_statement_begin__ = 132;
            for (int k = 1; k <= N_pt; ++k) {
                current_statement_begin__ = 134;
                lp_accum__.add(normal_log<propto__>(to_vector(stan::model::rvalue(y, stan::model::cons_list(stan::model::index_min_max((get_base1(id_start, k, "id_start", 1) + 1), get_base1(id_end, k, "id_end", 1)), stan::model::nil_index_list()), "y")), add(multiply(alpha, to_vector(stan::model::rvalue(y, stan::model::cons_list(stan::model::index_min_max(get_base1(id_start, k, "id_start", 1), (get_base1(id_end, k, "id_end", 1) - 1)), stan::model::nil_index_list()), "y"))), b), sigma));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_AR1_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        double y_inf = in__.scalar_constrain();
        vars__.push_back(y_inf);
        double lp__ = 0.0;
        ...
        try {
            ...
            for (int k = 1; k <= N_pt; ++k) {
                ...
                for (int t = get_base1(id_start, k, "id_start", 1); t <= (get_base1(id_end, k, "id_end", 1) - 1); ++t) {
                    ...
                    stan::model::assign(y_rep, 
                                ...
                                truncated_normal_rng(M, ((alpha * get_base1(y, t, "y", 1)) + b), sigma, base_rng__, pstream__), 
                                "assigning variable y_rep");
                }
            }
            ...
            for (int i = 1; i <= N_test; ++i) {
                ...
                if (as_bool(logical_eq(get_base1(id_start, get_base1(k_test, i, "k_test", 1), "id_start", 1), get_base1(idx_test, i, "idx_test", 1)))) {
                    ...
                    stan::model::assign(lpd, 
                                stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                                truncated_normal_lpdf(get_base1(y_test, i, "y_test", 1), M, ((alpha * get_base1(y, (get_base1(idx_test, i, "idx_test", 1) - 1), "y", 1)) + b), sigma, pstream__), 
                                "assigning variable lpd");
                }
            }
...
typedef model_AR1_namespace::model_AR1 stan_model;
#ifndef USING_R
