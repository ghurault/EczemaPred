...
We also write `BinRW2` methods for `default_prior`, `validate_prior` and `print_prior` which makes use of `NextMethod()` to call the methods for the parent class `BinRW`.
