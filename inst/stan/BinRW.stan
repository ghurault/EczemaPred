...
#include /include/data_lgtd_discrete.stan
  ...
  array[2] real prior_mu_logit_y0;
  array[2] real prior_sigma_logit_y0;
...
parameters {
  array[N] real eta; // Error term, non-centered parametrisation
...
transformed parameters {
  ...
  array[N_pt] real logit_y0; // Initial latent score
